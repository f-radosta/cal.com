...
const _eventTypeMetaDataSchemaWithoutApps = z.object({
  ...
  requiresConfirmationThreshold: z
    ...
    .optional(),
  rescheduleNoticeOrganizer: z.number().min(0).optional(),
  cancelNoticeOrganizer: z.number().min(0).optional(),
  cancelNoticeAttendee: z.number().min(0).optional(),
  requiresConfirmationForAttendeeReschedule: z.boolean().optional(),
  config: z
    .object({
