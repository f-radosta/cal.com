...
export default function RequiresConfirmationController({
  ...
  const requiresConfirmationForAttendeeReschedule =
    formMethods.getValues("metadata.requiresConfirmationForAttendeeReschedule") ?? true;
            ...
            <SettingsToggle
              ...
              onCheckedChange={(val) => {
                ...
                if (!val) {
                  ...
                  formMethods.setValue("metadata.requiresConfirmationForAttendeeReschedule", undefined, {
                    shouldDirty: true,
                  });
                } else {
                    ...
                    {(requiresConfirmationSetup !== undefined ||
                      ...
                      <>
                        ...
                        <div className="stack-y-2 -ml-1">
                          ...
                          />
                          <CheckboxField
                            checked={requiresConfirmationForAttendeeReschedule}
                            descriptionAsLabel
                            description={t("require_confirmation_for_attendee_reschedule")}
                            className={customClassNames?.conditionalConfirmationRadio?.checkbox}
                            descriptionClassName={
                              customClassNames?.conditionalConfirmationRadio?.checkboxDescription
                            }
                            onChange={(e) => {
                              formMethods.setValue(
                                "metadata.requiresConfirmationForAttendeeReschedule",
                                e.target.checked,
                                {
                                  shouldDirty: true,
                                }
